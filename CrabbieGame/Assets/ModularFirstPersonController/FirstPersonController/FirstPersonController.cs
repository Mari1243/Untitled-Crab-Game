...
public class FirstPersonController : MonoBehaviour
{
    ...
    public AudioSource shovelSwing;
    ...
    {
        //audios
        //sandOne = GameObject.Find("SandOne").GetComponent<AudioSource>();
    ...
    private void Update()
    {
        ...
        if (enableZoom)
        {
            ...
            if(holdToZoom && !isSprinting)
            {
                ...
                enterScript = GetComponent<Enter>();

                if (Input.GetKeyDown(zoomKey) && enterScript.hasShovel == true)
                {
        ...
        if(enableSprint)
        {
            ...
            {
                isZoomed = false;
                playerCamera.fieldOfView = Mathf.Lerp(playerCamera.fieldOfView, sprintFOV, sprintFOVStepTime * 1);
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            footsteps = GameObject.Find("Player").GetComponent<Animator>();
            ...
            if (targetVelocity.x != 0 || targetVelocity.z != 0 && isGrounded)
            {
                ...
                footsteps.SetBool("Footsteps", true);
            }
            else
            {
                footsteps.SetBool("Footsteps", false);
                isWalking = false;
